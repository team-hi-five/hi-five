...
function ChildCardMainPage() {
    ...
    const emotions = [
        { id: 1, name: "기쁘미", image: "/test/기쁘미.PNG", type:'joy',
          bgColor: "#FCFCD4",textColor: "rgb(246, 96, 145)"},
        { id: 2, name: "슬프미", image: "/test/슬프미.png", type:'sadness',
            bgColor: "#B7E1F9",textColor: "rgb(176, 149, 126)" },
        { id: 3, name: "화나미", image: "/test/화나미.PNG", type:'anger',
            bgColor: "#B5ABD8",textColor: "rgb(242, 233, 191)" },
        { id: 4, name: "무서미", image: "/test/무서미.PNG", type:'fear',
            bgColor: "#FB8B32",textColor: "rgb(93, 68, 72)" },
        { id: 5, name: "놀라미", image: "/test/놀라미.png", type:'surprise',
